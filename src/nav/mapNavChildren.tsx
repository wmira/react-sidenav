...
export const mapNavChildren = (context: ISideNavContext, props: INavProp & { children?: React.ReactNode }): Array<ReactElement<INavProp>> => {

    const navChildren: Array<ReactElement<INavProp>> = Children.toArray(props.children)
